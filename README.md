...
Système embarqué autonome pour la surveillance de la qualité de l'eau. Ce dépôt contient l'intégralité de la conception matérielle (schémas et routage PCB) ainsi que le firmware d'acquisition.
...
* 💻 **`/firmware`** : Code source en C gérant l'acquisition analogique, le traitement des signaux capteurs et la logique système.
